...
<html lang="en">
   ...
   <body>
         ...
         <div id="conatiner">
            <div id="game">
               <?php
                  ...
                  echo "<td width='80px' height='40px' align='center'  bgcolor='green'><img src= '".$_SESSION['players'][ 0 ][ "image" ].".png' /></td>";
                  }
                  ...
                  echo "<td width='80px' height='40px' align='center' bgcolor='cyan'><img src= '".$_SESSION['players'][ 1 ][ "image" ].".png'/></td>";
                  }else
                  {
                  if($count%2 ==0 && $tr%2 ==0)
                  {
	  ...
	  <div id="group1">
	  <label>
      <input type="radio" name="test" value="avatar1">
      <img src="avatar1.png" alt="Option 3" class="avatar" name = "image" checked>
      </label>
	  <label>
	  ...
	  <div id="group2">
	  <label>
      <input type="radio" name="test1" value="avatar1">
      <img src="avatar1.png" alt="Option 3" class="avatar" checked>
      </label>
	  <label>
